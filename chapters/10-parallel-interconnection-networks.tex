...
Many simulator projects intentionally use this simplified model, sometimes together with very deep input queues, so that the main architectural questions are message ordering, hop count, and contention rather than finite-buffer loss.
