...
\textit{Tomasulo's algorithm} is a classic out-of-order execution method that allows instructions to fire when their operands are ready rather than strictly in program order.
