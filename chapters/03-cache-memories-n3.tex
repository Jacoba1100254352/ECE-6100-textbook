...
When a problem asks which of $HT$, $MR$, or $MP$ changes, the cleanest mapping is usually:
\begin{enumerate}
...
This method is conceptually simple and is often the cleanest way to hand-simulate LRU on short traces.
