...
The exam-style reasoning is usually: identify the active data touched by one tile, multiply by bytes per element, require that footprint to fit in the effective cache capacity, and then remember that associativity can still matter.
...
\begin{enumerate}
    ...
    The cache hit time is 10 ns and the hit rate is 15\%.
