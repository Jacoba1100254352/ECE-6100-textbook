...
\begin{figure}[t]
    ...
    \begin{minipage}[t]{0.46\textwidth}
        \centering
        \textbf{Standalone shared-memory multiprocessor}\par
        \vspace{0.5ex}
        \resizebox{\linewidth}{!}{%
        \begin{tikzpicture}[every node/.style={font=\small}, >=Latex]
            \node[draw, minimum width=0.85in, minimum height=0.4in] (pe0) at (0,1.2) {PE 0};
            \node[draw, minimum width=0.85in, minimum height=0.4in] (pe1) at (1.4,1.2) {PE 1};
            \node[draw, minimum width=0.85in, minimum height=0.4in] (pe2) at (2.8,1.2) {PE 2};
            \node[draw, minimum width=0.85in, minimum height=0.4in] (pe3) at (4.2,1.2) {PE 3};
            \node[draw, rounded corners, minimum width=4.9in, minimum height=0.55in] (ic) at (2.1,0.15) {Shared interconnect / coherence fabric};
            \node[draw, minimum width=2.0in, minimum height=0.5in] (mem) at (2.1,-1.0) {Shared memory system};
            \draw[->] (pe0.south) -- (0,0.43);
            \draw[->] (pe1.south) -- (1.4,0.43);
            \draw[->] (pe2.south) -- (2.8,0.43);
            \draw[->] (pe3.south) -- (4.2,0.43);
            \draw[->] (2.1,-0.13) -- (mem.north);
        \end{tikzpicture}
        }
    \end{minipage}\hfill
    \begin{minipage}[t]{0.49\textwidth}
        \centering
        \textbf{Host plus accelerator organization}\par
        \vspace{0.5ex}
        \resizebox{\linewidth}{!}{%
        \begin{tikzpicture}[every node/.style={font=\small}, >=Latex]
            \node[draw, minimum width=1.35in, minimum height=0.45in] (cpu) at (0,1.2) {Host CPU};
            \node[draw, minimum width=1.45in, minimum height=0.45in] (hmem) at (0,-0.1) {Host memory};
            \node[draw, minimum width=1.7in, minimum height=0.45in] (link) at (2.3,0.55) {PCIe or similar link};
            \node[draw, minimum width=1.65in, minimum height=0.45in] (acc) at (4.7,1.2) {Accelerator PEs};
            \node[draw, minimum width=1.65in, minimum height=0.45in] (amem) at (4.7,-0.1) {Accelerator memory};
            \draw[->] (cpu.south) -- (hmem.north);
            \draw[->] (cpu.east) -- (link.west);
            \draw[->] (link.east) -- (acc.west);
            \draw[->] (acc.south) -- (amem.north);
        \end{tikzpicture}
        }
    \end{minipage}
