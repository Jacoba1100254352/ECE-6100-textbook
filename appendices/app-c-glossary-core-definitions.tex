...
This appendix collects first-pass definitions used throughout Chapters 1--8.
...
\begin{description}
    ...
    \item[\textit{Processing Element (PE)}] One independently executing processor, core, or execution agent within a multiprocessor system.
