...
\section*{Chapter 6 Formula Set (ILP, Superscalar, and Out-of-Order Execution)}\label{sec:ch6-formulas}
...
\paragraph{Chapter 6-F12 (Dependence Height)}\label{par:ch6-formula-12}
...
\paragraph{Chapter 6-F13 (Earliest Legal List-Scheduling Cycle)}\label{par:ch6-formula-13}
