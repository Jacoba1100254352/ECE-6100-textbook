...
\begin{equation}\label{eq:ch6-formula-throughput}
...
\begin{equation}\label{eq:ch6-formula-precise}
    \begin{aligned}
...
\begin{equation}\label{eq:ch6-formula-rat}
...
\begin{equation}\label{eq:ch6-formula-fire-ready}
...
\begin{equation}\label{eq:ch6-formula-retire}
...
\begin{equation}\label{eq:ch6-formula-exception}
    \begin{aligned}
...
\begin{equation}\label{eq:ch6-formula-height}
    height(i)=
    \begin{cases}
...
\begin{equation}\label{eq:ch6-formula-list-legal}
...
\begin{equation}\label{eq:ch6-formula-res-ii}
...
\begin{equation}\label{eq:ch6-formula-rec-ii}
...
\begin{equation}\label{eq:ch6-formula-min-ii}
