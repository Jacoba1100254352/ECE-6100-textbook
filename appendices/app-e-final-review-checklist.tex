...
It is not a substitute for the chapter practice questions; it is a last-pass checklist of the concepts that repeatedly connect worked problems, implementation exercises, and review questions.
...
For review problems, the first check is usually the footprint inequality: active arrays, tile dimensions, and bytes per element must fit within the effective cache capacity.
